 ...
 *
 * @param <AQuery> the generic type
 */
public class AQuery implements Constants {
	...
	protected AQuery create(View view){
		...
		try{
			Constructor<AQuery> c = getConstructor();
			result = (AQuery) c.newInstance(view);
			result.act = act;
		}catch(Exception e){
			//should never happen
			e.printStackTrace();
	...
	private Constructor<AQuery> constructor;
	@SuppressWarnings("unchecked")
	private Constructor<AQuery> getConstructor(){
		
		if(constructor == null){
		
			try{
				constructor = (Constructor<AQuery>) getClass().getConstructor(View.class);
			}catch(Exception e){
				//should never happen
				e.printStackTrace();
			}
	 ...
	 * @return self
	 */
	public AQuery recycle(View root){
		this.root = root;
		this.view = root;
		reset();
		this.context = null;
	...
	public AQuery progress(Object view){
		progress = view;		
		return self();
	}
	...
	public AQuery progress(Dialog dialog){
		progress = dialog;		
		return self();
	}
	 ...
	 * @return self
	 */
	public AQuery auth(AccountHandle handle){
		ah = handle;
		return self();
	}
	 ...
	 * @return self
	 */
	public AQuery transformer(Transformer transformer){
		trans = transformer;
		return self();
	}	
	
	public AQuery policy(int cachePolicy){
		policy = cachePolicy;
		return self();
	}	
	 ...
	 * @return self
	 */
	public AQuery proxy(String host, int port){
	 ...
	 */
	public AQuery text(int resid, Object... formatArgs) {
	 ...
	 * @return self
	 */
	public AQuery typeface(Typeface tf){
	...
	public AQuery image(String url){
	 ...
	 * @see testImage5
	 */
	public AQuery image(String url, boolean memCache, boolean fileCache){		
	 ...
	 * @see testImage6
	 */
	public AQuery image(String url, boolean memCache, boolean fileCache, int targetWidth, int fallbackId){
	 ...
	 * 
	 */
	public AQuery image(String url, boolean memCache, boolean fileCache, int targetWidth, int fallbackId, Bitmap preset, int animId){
	 ...
	 * 
	 */
	public AQuery image(String url, boolean memCache, boolean fileCache, int targetWidth, int fallbackId, Bitmap preset, int animId, float ratio){
		return image(url, memCache, fileCache, targetWidth, fallbackId, preset, animId, ratio, 0, null);
	}
	
	protected AQuery image(String url, boolean memCache, boolean fileCache, int targetWidth, int fallbackId, Bitmap preset, int animId, float ratio, int round, String networkUrl){
	...
	public AQuery image(String url, ImageOptions options){
		return image(url, options, null);
	}
	
	protected AQuery image(String url, ImageOptions options, String networkUrl){
	...
	public AQuery image(BitmapAjaxCallback callback){
	 ...
	 * @see testImage9
	 */
	public AQuery image(String url, boolean memCache, boolean fileCache, int targetWidth, int resId, BitmapAjaxCallback callback){
	...
	public AQuery image(File file, int targetWidth){		
	 ...
	 * @see testImage11
	 */
	public AQuery image(File file, boolean memCache, int targetWidth, BitmapAjaxCallback callback){
	 ...
	 * 
	 */
	public AQuery image(Bitmap bm, float ratio){
	 ...
	 * @return self
	 */
	public AQuery tag(int key, Object tag){
	 ...
	 * @return self
	 */
	public AQuery enabled(boolean enabled){
	 ...
	 * @return self
	 */
	public AQuery clickable(boolean clickable){
	 ...
	 * @return self
	 */
	public AQuery visibility(int visibility){
	 ...
	 * @return self
	 */
	public AQuery backgroundColor(int color){
	 ...
	 * @return self
	 */
	public AQuery clicked(OnClickListener listener){
	 ...
	 * @return self
	 */
	public AQuery longClicked(Object handler, String method){
	 ...
	 * @return self
	 */
	public AQuery longClicked(OnLongClickListener listener){
	 ...
	 * @return self
	 */
	public AQuery itemClicked(Object handler, String method){
	 ...
	 * @return self
	 */
	public AQuery itemSelected(Object handler, String method){
	 ...
	 * @return self
	 */
	public AQuery itemSelected(OnItemSelectedListener listener){
	 ...
	 * @return self
	 */
	public AQuery scrolledBottom(Object handler, String method){
	 ...
	 * @return self
	 */
	public AQuery scrolled(OnScrollListener listener){
	 ...
	 * @return self
	 */
	public AQuery textChanged(Object handler, String method){
	 ...
	 * @return self
	 */
	public AQuery overridePendingTransition5(int enterAnim, int exitAnim){
	 ...
	 * @return self
	 */
	public AQuery setOverScrollMode9(int mode){
	 ...
	 * @return self
	 */
	public AQuery setLayerType11(int type, Paint paint){
	 ...
	 * @return self
	 */
	public AQuery margin(float leftDip, float topDip, float rightDip, float bottomDip){
	...
	public AQuery width(int width, boolean dip){		
		size(true, width, dip);		
		return self();
	}
	...
	public AQuery height(int height, boolean dip){		
	...
	protected <K> AQuery invoke(AbstractAjaxCallback<?, K> cb){
	...
	public <K> AQuery ajax(String url, Class<K> type, AjaxCallback<K> callback){
	...
	public <K> AQuery ajax(String url, Class<K> type, long expire, AjaxCallback<K> callback){
	...
	public <K> AQuery ajax(String url, Class<K> type, Object handler, String callback){
	...
	public <K> AQuery ajax(String url, Class<K> type, long expire, Object handler, String callback){
	...
	public <K> AQuery ajax(String url, Map<String, ?> params, Class<K> type, AjaxCallback<K> callback){
	...
	public <K> AQuery ajax(String url, Map<String, ?> params, Class<K> type, Object handler, String callback){
	...
	public <K> AQuery delete(String url, Class<K> type, AjaxCallback<K> callback){
	...
	public <K> AQuery put(String url, String contentHeader, HttpEntity entity, Class<K> type, AjaxCallback<K> callback){
	...
	public <K> AQuery delete(String url, Class<K> type, Object handler, String callback){
	...
	public <K> AQuery sync(AjaxCallback<K> callback){
		ajax(callback);
		callback.block();
		return self();
	}
	 ...
	 * @see testCache
	 */
	public AQuery cache(String url, long expire){		
	 ...
	 * @return self
	 */
	public AQuery invalidate(String url){
	 ...
	 * 
	 */
	public AQuery animate(int animId){
	 ...
	 * 
	 */
	public AQuery animate(int animId, AnimationListener listener){
	 ...
	 * 
	 */
	public AQuery animate(Animation anim){
	 ...
	 * 
	 */
	public AQuery webImage(String url){
	 ...
	 * 
	 */
	public AQuery webImage(String url, boolean zoom, boolean control, int color){
	...
	public AQuery download(String url, File target, AjaxCallback<File> cb){
	...
	public AQuery download(String url, File target, Object handler, String callback){
